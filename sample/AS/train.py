...
class Trainer:
    ...
    def trainG(self, model, model_dir, results_dir, batch_gen_source, batch_gen_target, device, args):
        ...
        optimizer = optim.Adam([{'params': self.model.parameters(),'lr':learning_rate},
                                {'params': model.gcn.parameters(),'lr':self.args.goat_lr},{'params': model.mh.parameters(),'lr':self.args. _lr}])
        ...
        for epoch in range(resume_epoch, num_epochs):
            ...
            while batch_gen_source.has_next():
                ...
                # ====== Feed-forward data ====== #
                # prepare inputs
                input_source, label_source, mask_source,bfs,bis = batch_gen_source.next_batchG(batch_size_source, 'source')
                ...
                input_target, label_target, mask_target,bft,bit = batch_gen_target.next_batchG(batch_size_target, 'target')
