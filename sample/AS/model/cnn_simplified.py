...
class GCNnet_artisticswimming_simplified(nn.Module):
    ...
    def __init__(self, args):
        ...
        NFR, NFG = self.args.num_features_relation, self.args.num_features_gcn # 256
    ...
    def forward(self, boxes_features, boxes_in):
        torch.Size([1, 550, 8, 4])
        torch.Size([1, 6076, 8, 1024])
        ...
        # reshape as query
        boxes_states = boxes_states.mean(2)  # B,540,1024
